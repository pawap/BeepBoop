 ...
 * 
 * Controller for the BeepBoop player. Reacts on input it receives via the
 * MainController. Manipulates the Player and the Level.
 * 
...
public class PlayerController {
	 ...
	 * @param mf
	 *            the gui
	 * @param robotTerminalController
	 *            RobotTerminalController
	 */
	...
	/*
	 * Moves the player avatar to the specified new position if it is free or
	 * interacts with the thing at the specified position
	 * 
	...
	/**
	 * Moves the player avatar to the left if possible or interacts with the
	 * Thing to the left of the player if there is a Thing that can be
	 * interacted with.
	 */
	...
	/**
	 * Moves the player avatar to the right if possible or interacts with the
	 * Thing to the right of the player if there is a Thing that can be
	 * interacted with.
	 */
	...
	/**
	 * Moves the player avatar down if possible or interacts with the Thing
	 * below the player if there is a Thing that can be interacted with.
	 */
