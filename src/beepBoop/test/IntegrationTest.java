...
import beepBoop.controller.RobotController;
...
public class IntegrationTest {
	...
	public void setup() {
		...
		gui.initLevelUI(lvl);
		gui.initTerminalUI();
		plrCtrl = new PlayerController(gui,new RobotTerminalController(gui.getTerminalUI(), new RobotQueue(), new RobotController(lvl)));		
