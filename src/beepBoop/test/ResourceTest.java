...
public class ResourceTest {
	...
	public void takeAmount_takeAll_AmountIsZero() {
		...
		// assert
		assertTrue("Took everything. What was left was not 0", someResource.getAmount() == 0);
	}
	...
	public void takeAmount_takeTooMuch_AmountIsZero() {
		...
		// assert
		assertTrue("Took too much. What was left was not 0.", someResource.getAmount() == 0);
	}
	...
	public void takeAmount_takeTooMuch_returnAllAvailable() {
		...
		// assert
		assertTrue("Took too much. Did not return as much as had been there.", amountTaken == someAmount);
	}
	...
	public void increaseAmount_increaseALittle_AmountEqualsSum() {
		...
		// assert
		assertTrue("Wrong amount after increase.", someResource.getAmount() == someAmount + someOtherAmount);
	}
