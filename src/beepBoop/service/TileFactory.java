...
public class TileFactory {
	...
	// ground tile ids, declared as public to facilitate development
	// Therefore Javadoc is not included for these
	...
	/**
	 * Returns the instance of the TileFactory singleton, creates it if
	 * necessary.
	 * 
	...
	/**
	 * Returns the tile with the specified Id. Tile Ids can be accessed via the
	 * static fields of TileFactory.
	 * 
	 * @param tileId
	 ...
	 * 
	 * @param name
	 *            an element of {"copper", "gold", "iron", "platinum",
	 *            "silicon"}
	 * @return the Tile ID of the Resource, or the ID of the null Tile, if the
