...
public class Command
{
    ...
    /**
     * Constructor
     * @param commandStr first the type, then the arguments; separated by spaces
     */
    ...
    /**
     * Translates a given position into a new position, 1 tile away, based on a given direction
     * @param position the origin position
     * @param direction element in {"L", "R", "U", "D"}
