 ...
 * 
 * The model class for beepbop resources, Resources are Things in a level. The
 * type of a resource is defined by its name.
 * 
...
public class Resource extends Thing {
	 ...
	 * @param tileId
	 *            one of the static values stored in TileFactory
	 * @param name
	 ...
	 * 
	 * @param increase
	 *            the amount the Resource should be increased by
	 */
