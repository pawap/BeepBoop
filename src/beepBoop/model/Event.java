...
abstract public class Event extends Observable implements Delayed, Serializable {
	...
	/**
	 * Method called by the controller, when an event happens.
	 * All Changes made to the level or other Actions taken during
	 * the event are performed in this method
	 * 
	 * @param level The current level is made available in this param by the controller
	 */
	 ...
	 * 
	 * @param beeps desired delay in seconds
	 */
