 ...
 * 
 * This event drops a certain number of each Resource with random amounts (less
 * than 100) in random places within the rectangle bounded by the two given
 * Points
 * 
...
public class ResourceDropEvent extends Event {
	 ...
	 * 
	 * @param dropsPerType
	 *            number of Resources to drop per type
	 */
