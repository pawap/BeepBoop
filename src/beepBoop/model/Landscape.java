 ...
 * 
 * A Landscape holds a grid of tiles. Each BeepBoop Level uses a Landscape which
 * defines the basic terrain.
 * 
...
public class Landscape implements Serializable {
	 ...
	 * 
	 * @param size
	 *            the width and height of the Landscape measured in tiles
	 */
	...
	/**
	 * Set the size of the Landscape. As many of the old Tiles as fit in the new
	 * Dimension are kept.
	 * 
	 * @param size
	 ...
	 * @param type
	 *            the desired Tile type. One of the static values stored in
	 *            TileFactory.
	 */
	 ...
	 * 
	 * @param x
	 *            the x coordinate of the Tile to be placed
	 * @param y
	 *            the y coordinate of the Tile to be placed
	 * @param tileId
	 *            the desired Tile type. One of the static values stored in
	 *            TileFactory.
	 */
