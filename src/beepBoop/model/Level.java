...
public class Level implements Serializable{
	...
	/**
	 * Adds a Thing to the Level if its position corresponds to a free, walkable tile in the Landscape
	 ...
	 * @param oldPoint the position of the Thing to be moved
	 * @param newPoint the target position
	 */
	 ...
	 * @param x the x coordinate of the Thing to be returned
	 * @param y the y coordinate of the Thing to be returned
