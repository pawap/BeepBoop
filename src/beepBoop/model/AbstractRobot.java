...
public abstract class AbstractRobot extends Thing {
	 ...
	 * 
	 * @param pc
	 *            the desired value for the program counter
	 */
	...
	/**
	 * @param name
	 *            the identifier for a specific sensor
	 ...
	 * 
	 * @param load
	 *            the value the cargo should be increased by
	 */
	 ...
	 * 
	 * @param load
	 *            the amount the cargo should be reduced by
	...
	/**
	 * @return the value, which the activity-counter of the robot-type needs to
	 *         reach in order for the next command to be processed.
	 */
