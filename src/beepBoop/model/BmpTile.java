...
public class BmpTile extends Tile {
	...
	/**
	 * Constructor The tile name should match a .bmp file located in the assets
	 * folder. If it doesn't or the file cannot be accessed, a red "error-tile"
	 * is created instead.
	 * 
	 * @param tileName
	 * @param walkable
	...
	public BmpTile(String tileName, boolean walkable) {
		...
		// try to load the image from the corresponding bmp-file, create a red
		// errorTile if this fails.
		try {
